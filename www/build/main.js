...
var MyApp = (function () {
    function MyApp(platform, statusBar, app, toast, splashScreen, navCtrl, oneSignal, ga, screenOrientation, diagnostic) {
        var _this = this;
        this.platform = platform;
        this.app = app;
        this.toast = toast;
